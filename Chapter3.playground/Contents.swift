...
/*
 ...
 \": 문자열 내 큰따옴표를 표현하고자 할 때 사용
 \t: 탭 문자
 \0: 문자열이 끝났음을 알리는 null 문자
 */
print("문자열 내부에\n 이런 \"특수문자\"를\t사용하면 \\이런 놀라운 결과를 볼 수 있다.")
print(#"문자열 내부에서 특수문자를 사용하기 싫다면 문자열 앞, 뒤에 #을 붙여라.그러면 \n와 같이 특수문자가 그대로 출력된다."#)

let number:Int = 100
print(#"특수문자를 사용하지 않을 때도 문자열 보간법을 사용하고 싶다면 이렇게 \#(number) 을 해라"#)

/*
 3-9 Any
 Any: 스위프트의 모든 데이터 타입을 사용할 수 있다.
 AnyObject: Any보다는 한정된 의미로 클래스의 인스턴스만 할당할 수 있다.
 nill: '없음' 변수 또는 상수에 값이 들어있지 않고 비어있음을 나타내는데 사용한다.
 */
var someVar:Any = "88yhtserof"
someVar = 12
someVar = 200.3
//Any로 선언된 변수에는 문자열, 정수, 실수 또는 어떤 타입의 값이라도 할당할 수 있다.
